...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-219266269dbaaf0f"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-219266269dbaaf0f",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-219266269dbaaf0f",
        "url": "https://en.wikipedia.org/wiki/Lebesgue%27s_universal_covering_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Lebesgue's universal covering problem on the minimum-area convex shape in the plane that can cover any shape of diameter one",
      "version": 1
    },
    "title": "Lebesgue's universal covering problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "82d8518ad8a3dbe7d7992f4e0e9c60861a73e0c77a31724e2a78221147706dd4"
}
```
